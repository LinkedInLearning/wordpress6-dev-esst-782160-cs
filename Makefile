...
install:
    ...
    wordpress:cli wp core install --url=https://$(CODESPACE_NAME) --title=WordPress --admin_user=admin --admin_password=password --admin_email=mail@example.com && wp language core install de_DE --activate
